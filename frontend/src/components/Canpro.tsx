...
function Canpro(){
    return(
        <>
            <Cside />
            <div className="flex flex-col w-3/4 mt-[100px] min-h-screen ml-[25%] bg-[#f8fafc] p-10 gap-5">
                <div className="flex">
                ...
                <div className="flex flex-col p-10 gap-5 bg-white rounded-lg shadow">
                    ...
                    <div className="flex gap-5">
                        <div className="flex flex-col w-1/3">
                            <label className="block text-sm text-gray-500">Profile Photo</label>
                            <label className="flex flex-col items-center w-full max-w-lg p-5 mx-auto mt-2 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer rounded-xl">
                                ...
                                <h2 className="mt-1 font-medium tracking-wide text-gray-700">Browse Photo</h2>
                        ...
                        <div className="flex flex-col w-2/3 gap-y-3">
                            <div className="flex gap-2">
                                <div className="flex flex-col w-1/2 p-1 gap-1">
                                    <label htmlFor="Comapnay name" className="text-lg font-normal">Full Name</label>
                                    <input type="text" name="Company name" id="Comapany name" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                                <div className="flex flex-col w-1/2 p-1 gap-1 font">
                                    <label htmlFor="Email" className="text-lg font-normal">Email</label>
                                    <input type="text" name="Email" id="Email" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                            </div>
                            <div className="flex gap-2">
                                <div className="flex flex-col w-1/2 p-1 gap-1">
                                    <label htmlFor="Phone" className="text-lg font-normal">Phone</label>
                                    <input type="tel" name="Phone" id="Phone" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                                <div className="flex flex-col w-1/2 p-1 gap-1 font">
                                    <label htmlFor="Account type" className="text-lg font-normal">Account type</label>
                                    <input type="text" name="Account type" id="Account type" value="Worker" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                            </div>
                            <div className="flex gap-2">
                                <div className="flex flex-col w-1/2 p-1 gap-1">
                                    <label htmlFor="Age" className="text-lg font-normal">Age</label>
                                    <input type="text" name="Age" id="Age" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                                <div className="flex flex-col w-1/2 p-1 gap-1 font">
                                    <label htmlFor="Categories" className="text-lg font-normal">Categories</label>
                                    <input type="text" name="Categories" id="Categories" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <h5>About Me</h5>
                        <textarea name="aboutm" id="aboutm" className="flex p-5 bg-[#f9fafb] rounded-2xl h-72 resize-none"></textarea>
                    ...
                    <div className="flex flex-col">
                        <div className="flex gap-2">
                            <div className="flex flex-col w-1/2 p-1 gap-1">
                                ...
                                <input type="text" name="Country" id="Country" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                            </div>
                            <div className="flex flex-col w-1/2 p-1 gap-1 font">
                                <label htmlFor="City" className="text-lg font-normal">City</label>
                                <input type="text" name="City" id="City" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                            </div>
                        </div>
                        <div className="flex flex-col p-1 gap-1">
                            <label htmlFor="Complete Address" className="text-lg font-normal">Complete Address</label>
                            <input type="text" name="Complete Address" id="Complete Address" className="flex p-3 bg-[#f9fafb] rounded-xl"/>
                        </div>
                    </div>
